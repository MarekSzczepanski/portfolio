...
export function ChevronLeft(props) {
  const { top, left, width, marginTop, active } = props;
  return (
    <Image
...
export function TreeImage(props) {
  return (
    <Image
      src={props.image}
      alt="tree"
...
export function DeerFemaleImage() {
  return (
    <Image
      src="deer-female.png"
      alt="Deer female"
...
export function BlockchainImageMobile() {
  return (
    <>
      <Image
        src="blockchain.png"
...
export function DecentralizationImage() {
  return (
...
export function TransparencyImage() {
  return (
...
export function CryptocurrenciesImage() {
  return (
...
export function GuitarImageMobile() {
  return (
    <Image
      src="guitar.png"
      alt="guitar"
...
export function DragonImage() {
  return <Image src="dragon.png" alt="dragon" style={{}} />;
}

export function DrumsImage() {
  return <Image src="drums.png" alt="drums" style={{}} />;
}

export function FireImage() {
  return <Image src="fire.png" alt="fire" style={{}} />;
}

export function BassImage() {
  return (
    <Image
      src="bass.png"
      alt="bass"
...
export function UnicornImage() {
  return <Image src="unicorn.png" alt="unicorn" style={{}} />;
}

export function SingerImage() {
  return <Image src="singer.png" alt="singer" style={{}} />;
}

export function KnightImage() {
  return <Image src="knight.png" alt="knight" style={{}} />;
}

export function SwordImage() {
  return (
    <Image
      src="sword.png"
      alt="sword"
...
export function CastleImage() {
  return <Image src="castle.png" alt="castle" style={{}} />;
}

export function ElfImage() {
  return <Image src="elf.png" alt="elf" style={{}} />;
}

export function DwarfImage() {
  return <Image src="dwarf.png" alt="dwarf" style={{}} />;
}

export function LightningImage() {
  return (
    <Image
      src="lightning.png"
      alt="lightning"
...
export function NoteImage() {
  return <Image src="note.png" alt="note" style={{}} />;
}
...
export const mainPowerMetalImages = [
  {
    ...
    animation: transformFromTo(
      ...
      'translate(-2vw, -1vw) rotate(-15deg)'
    ),
    origin: 'bottom',
  },
  {
  ...
  },
  {
    ...
    animation: transformFromTo(
      ...
      'translate(-2vw, -1vw) rotate(-30deg)'
    ),
    origin: 'bottom',
  },
  {
