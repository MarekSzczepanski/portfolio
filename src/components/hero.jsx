...
const translate4 = {x1: '0vw', x2: '-3vw', x3: '-2vw', x4: '-1vw', x5: '0vw', x6: '-1vw', x7: '-2vw', x8: '-4vw', x9: '0vw', y1: '5vw', y2: '3vw', y3: '5vw', y4: '5vw', y5: '5.5vw', y6: '3vw', y7: '2vw', y8: '3vw', y9: '5vw'};
...
const mTranslate4 = {x1: '-35vw', x2: '-34vw', x3: '-34vw', x4: '-37vw', x5: '-34vw', x6: '-37vw', x7: '-36vw', x8: '-33vw', x9: '-35vw', y1: '-37vw', y2: '-34vw', y3: '-40vw', y4: '-38vw', y5: '-38vw', y6: '-40vw', y7: '-38vw', y8: '-37vw', y9: '-37vw'};
  ...
  return (
    <>
      ...
      <a href='https://github.com/MarekSzczepanski' target='_blank' rel='noopener noreferrer'>
        <Blob measure='10vw' top='1vw' left='55vw' mMeasure='18vw' mTop='40vw' mLeft='75vw' translate={translate4} mTranslate={mTranslate4} image='github.png' rotateBack={true} borderColor='none' cursor='pointer' zIndex='2'></Blob>
      </a>
