...
const skills = ['html', 'css', 'git', 'mysql', 'mongodb', 'express', 'cypress', 'jest', 'gatsby', 'gsap', 'three.js', 'graphql', 'rest', 'ci / cd', 'npm', 'eslint', 'webpack'];
...
const Skills = () => (
  <Container>
    ...
    {skills.map(function(object, i){
      return <Blob key={i} color={colors[i]} border={'black'} text={skills[i]} delay={i * 1.36} zIndex={i} skill={true} translate={translate} mTranslate={mTranslate} measure='9vw' mMeasure='25vw' rotateBack={true}/>;
    })}
    <Blob color={'#f0DB4F'} border={'black'} text={'javascript'} skill={true} zIndex={21} fontSize={'1.5vw'} measure='16vw' mMeasure='38vw' translate={translate1} mTranslate={mTranslate1} rotateBack={true}/>
    <Blob color={'#61DBFB'} border={'black'} text={'react'} skill={true} zIndex={22} delay={.5} fontSize={'1.5vw'} measure='15vw' mMeasure='40vw' translate={translate2} mTranslate={mTranslate2} rotateBack={true}/>
    <Blob color={'#68A063'} border={'black'} text={'nodejs'} skill={true} zIndex={20} delay={1} fontSize={'1.5vw'} measure='14vw' mMeasure='37vw' translate={translate3} mTranslate={mTranslate3} rotateBack={true}/>
  </Container>
)
